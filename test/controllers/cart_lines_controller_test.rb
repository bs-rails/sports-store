...
class CartLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_line" do
    assert_difference("CartLine.count") do
      post cart_lines_url, params: { cart_line: { cart_id: @cart_line.cart_id, product_id: @cart_line.product_id, quantity: @cart_line.quantity } }
    end
  ...
  test "should update cart_line" do
    patch cart_line_url(@cart_line), params: { cart_line: { cart_id: @cart_line.cart_id, product_id: @cart_line.product_id, quantity: @cart_line.quantity } }
